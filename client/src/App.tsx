...
const S: Record<string, React.CSSProperties> = {
  ...
  logo: {
    ...
    fontWeight: 700, fontSize: 22, color: 'var(--text)', letterSpacing: '-0.7px',
  },
  logoCollapsed: {
  ...
  navItem: {
    ...
    cursor: 'pointer', borderRadius: 14, fontSize: 16, textAlign: 'left',
  ...
  searchInput: { flex: 1, background: 'transparent', border: 'none', outline: 'none', color: 'var(--text)', fontSize: 16, padding: '12px 0', fontFamily: 'inherit' },
  ...
  thCell: { display: 'flex', alignItems: 'center', gap: 4, color: 'var(--text-muted)', fontSize: 13, textTransform: 'uppercase', letterSpacing: 0.9, cursor: 'pointer', userSelect: 'none', padding: '0 6px', fontWeight: 700 },
  ...
  panelTitle: { fontSize: 20, fontWeight: 700, marginBottom: 20, color: 'var(--text)' },
  addForm: { display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' },
  input: { flex: 1, backgroundColor: 'var(--bg)', border: '1px solid var(--border)', color: 'var(--text)', borderRadius: 6, padding: '8px 12px', fontSize: 15, fontFamily: 'inherit', outline: 'none' },
  btnPrimary: { display: 'flex', alignItems: 'center', gap: 6, backgroundColor: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 6, padding: '8px 16px', cursor: 'pointer', fontSize: 15, fontFamily: 'inherit', fontWeight: 600 },
  btnSecondary: { display: 'flex', alignItems: 'center', gap: 6, backgroundColor: 'var(--bg)', color: 'var(--text-muted)', border: '1px solid var(--border)', borderRadius: 6, padding: '6px 12px', cursor: 'pointer', fontSize: 14, fontFamily: 'inherit' },
  ...
  libPath: { color: 'var(--accent)', fontSize: 14, marginBottom: 4 },
  ...
  modalTitle: { fontWeight: 700, fontSize: 18, color: 'var(--text)', marginBottom: 4 },
  modalSub: { color: 'var(--text-muted)', fontSize: 15 },
  ...
  metaLabel: { color: 'var(--text-muted)', fontSize: 13, textTransform: 'uppercase', letterSpacing: 0.8, padding: '5px 12px 5px 0', verticalAlign: 'top', width: 110, whiteSpace: 'nowrap' },
  metaValue: { color: 'var(--text)', padding: '5px 0', wordBreak: 'break-all', fontSize: 15 },
  tabBar: { display: 'flex', borderBottom: '1px solid var(--border)', flexShrink: 0 },
  tab: { padding: '10px 20px', background: 'transparent', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: 15, fontFamily: 'inherit', borderBottom: '2px solid transparent', marginBottom: -1 },
  ...
  quickSectionLabel: { fontSize: 12, color: 'var(--text-muted)', textTransform: 'uppercase' as const, letterSpacing: 1, padding: '8px 16px 6px', fontWeight: 700 },
  quickRow: {
  ...
  quickName: { fontSize: 15, fontWeight: 700, flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const },
  quickMeta: { fontSize: 13, color: 'var(--text-muted)', flexShrink: 0, whiteSpace: 'nowrap' as const, fontWeight: 600 },
  ...
  sectionDividerLabel: { fontSize: 12, color: 'var(--text-muted)', textTransform: 'uppercase' as const, letterSpacing: 1, fontWeight: 600 },
};
