...
const styles: Record<string, React.CSSProperties> = {
  ...
  panelTitle: { color: 'var(--text)', fontSize: 12, fontWeight: 800 },
  refreshButton: {
    minHeight: 44,
    padding: '0 12px',
    border: 'none',
  ...
  metricValue: { color: 'var(--text)', fontSize: 16, fontWeight: 800 },
  subsection: {
    display: 'grid',
    gap: 9,
    paddingTop: 12,
  ...
  subsectionTitle: { color: 'var(--text)', fontSize: 12, fontWeight: 800 },
  subsectionCopy: {
    marginTop: 3,
    color: 'var(--text-muted)',
    fontSize: 10,
  ...
  libraryMeta: { color: 'var(--text-muted)', fontSize: 9 },
  libraryPath: {
    overflow: 'hidden',
    color: 'var(--text-faint)',
    fontSize: 8,
  ...
  queueCount: { color: 'var(--text)', fontSize: 12 },
  runtimeHeader: {
    display: 'flex',
    alignItems: 'start',
    justifyContent: 'space-between',
  ...
  fieldLabel: { color: 'var(--text)', fontSize: 10, fontWeight: 750 },
  select: {
    width: '100%',
    minWidth: 0,
    minHeight: 44,
