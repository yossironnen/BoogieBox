...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { color: 'var(--text)', fontSize: 15, fontWeight: 800 },
  subtitle: { color: 'var(--text-muted)', fontSize: 11, lineHeight: 1.4 },
  experimental: {
    padding: '5px 7px',
    borderRadius: 999,
  ...
  chevron: { color: 'var(--accent)', fontSize: 20, fontWeight: 700, textAlign: 'center' },
  body: {
    display: 'grid',
    gap: 12,
  ...
  sectionTitle: { color: 'var(--text)', fontSize: 13, fontWeight: 800 },
  meta: { marginTop: 3, color: 'var(--text-muted)', fontSize: 11, lineHeight: 1.45 },
  runtimeBadge: {
    flexShrink: 0,
    padding: '5px 7px',
    borderRadius: 999,
  ...
  runtimeSummary: { color: 'var(--text-muted)', fontSize: 11, lineHeight: 1.45 },
  queued: { color: 'var(--success)', fontSize: 11, fontWeight: 700 },
  controlsGrid: {
    display: 'grid',
  ...
  progressValue: { color: 'var(--accent)', fontSize: 13 },
  progressTrack: {
    height: 5,
    overflow: 'hidden',
    borderRadius: 999,
